...
export default function Sidebare() {
    return (
        <aside className="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <img src="BackTemplate/dist/img/AdminLTELogo.png" alt="AdminLTE Logo" className="brand-image img-circle elevation-3" style={{opacity: '.8'}} />
            <span className="brand-text font-weight-light">ZYONEFOOD</span>
            </a>
            {/* Sidebar */}
            ...
            <div className="user-panel mt-3 pb-3 mb-3 d-flex">
                <div className="image">
                <img src="BackTemplate/dist/img/user2-160x160.jpg" className="img-circle elevation-2" alt="User Image" />
                </div>
                <div className="info">
            ...
            <nav className="mt-2">
                ...
                <li className="nav-item">
                    <InertiaLink  href="/logout" method="post" className="nav-link">
                        <i className="nav-icon fas fa-sign-out-alt bg-success" />
